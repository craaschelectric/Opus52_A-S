...
// Row 2 y-center = 285: Config (left, hidden if HIDE_CONFIG_SCREEN), Save (right)

static BUTTON memDownButton      = {"Mem -",     60, 213, 110, 70};
static BUTTON memUpButton        = {"Mem +",    180, 213, 110, 70};
static BUTTON operConfigButton   = {"Config",    60, 285, 110, 70};
...
static void drawOperational() {
    ...
    if (!HIDE_CONFIG_SCREEN) ui.drawButton(operConfigButton);
